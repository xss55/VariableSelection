...
vignette: >
  %\VignetteIndexEntry{Variable selection for linear models and generalized linear models with BIC-based posterior probability}
...
You can install `VariableSelection` from CRAN with:
